...
public class DatabaseSeeding implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post = new Post(null, Instant.now(), "Partiu Miami!", "Hoje é o dia da viagem para Miami para os amistosos de pré-temporada! Siuu", user);
		Post post2 = new Post(null, Instant.now(), "Esqueci minhas chuteiras!", "Lembrei-me agora que minhas chuteiras ficaram no CT do clube! Terei que dar um jeito", user);
